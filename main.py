    ...
    def generate():
        ...
        if redcFontSize == 1:
            cssContent2 = cssContent.replace(
                ...
                "facebook__title{font-size:11px;line-height:20px}",
            )
            cssContent3 = cssContent2.replace(
                ...
                "facebook__description{border-collapse:separate;color:#606770;direction:ltr;display:-webkit-box;font-family:Helvetica, Arial, sans-serif;font-size:9px;height:13px;line-height:20px;",
            )
